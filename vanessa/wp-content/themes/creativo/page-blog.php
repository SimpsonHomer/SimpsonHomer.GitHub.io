						...
						?>
							<div class="flexslider" data-interval="0" data-flex_fx="fade">
								<ul class="slides">
									...
									?>
                                    <?php 
                                    	if($extra ==''){ $hover = '<span class="gallery_zoom"><img src="'.get_bloginfo('template_directory').'/images/img-ovr6.png" /></span>';} else $hover =''; 
                                    ?>
									...
									?>
                                        ...
                                        <li>
                                        	<div class="full-blog">
                                            	<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('blog-large'); echo $hover; ?></a>  
                                            </div>                                      
                                        </li>
                                        <?php echo $extra; ?>
									<?php
