...
/*-----------------------------------------------------------------------------------*/
		...
		<h3 class="comments-title"><?php _e('Your thoughts here', 'Creativo') ?></h3>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond">
		...
		<h3 class="reply-title"><?php comment_form_title( __('Leave a Reply', 'Creativo'), __('Leave a Reply to %s', 'Creativo') ); ?></h3>
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit Comment', 'Creativo') ?>" class="button small default" />
