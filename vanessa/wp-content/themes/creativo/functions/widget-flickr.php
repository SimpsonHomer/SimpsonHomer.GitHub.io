...
class Flickr_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'flickr', 'description' => __('The most recent photos from flickr.','Creativo'));

		$control_ops = array('id_base' => 'flickr-widget');

		$this->WP_Widget('flickr-widget', __('Creativo Flickr','Creativo'), $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'My Photostream', 'screen_name' => '', 'number' => 6);
		...
		<p>
			<label for="<?php echo $this->get_field_id('screen_name'); ?>"><?php _e('Screen name:','Creativo');?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of photos to show:','Creativo');?></label>
