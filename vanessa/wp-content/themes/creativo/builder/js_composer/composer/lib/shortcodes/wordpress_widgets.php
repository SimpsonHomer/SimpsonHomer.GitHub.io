...
class WPBakeryShortCode_VC_Wp_Flickr_Widget extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Custom_Posts extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Custom_Portf extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Rec_Pop_Tabs extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Contact_Us extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Social_Links extends WPBakeryShortCode {
}
class WPBakeryShortCode_VC_Wp_Twitter_Feed extends WPBakeryShortCode {
}
?>