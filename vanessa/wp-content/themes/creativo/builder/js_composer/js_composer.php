...
if( !$vc_as_theme && is_file(get_template_directory() . '/builder/js_composer/js_composer.php') ) {
    // Load from theme
} else {
    // {{{ constants
     ...
     */
    if($vc_as_theme) {
        load_theme_textdomain('js_composer', get_template_directory() . '/builder/js_composer/theme_locale');
    } else {
