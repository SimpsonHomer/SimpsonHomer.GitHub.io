...
define('CS_REST_WRAPPER_VERSION', '1.0.11');
...
class CS_REST_Wrapper_Base {
    ...
    $api_key, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = NULL, $serialiser = NULL, $transport = NULL) {
