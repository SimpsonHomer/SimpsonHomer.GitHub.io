...
;(function($){
	$(document).ready(function(){
		...
		$('#clear-ab-cookie').live('click',function(){
  		var thisABCampaignID = $('.campaigncookieid').val();
  		var expires = new Date();
			expires.setDate(expires.getDate() - 1);
		  //window.cookie('popup_domination_hide_ab'+thisABCampaignID,'',expires);
		  document.cookie = 'popup_domination_hide_ab'+thisABCampaignID+'="";expires='+expires.toGMTString()+';path=/';
		  return false;
		});
	})
