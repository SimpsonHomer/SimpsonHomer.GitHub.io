...
<div class="wrap" id="ls-list-page">
	...
	<div id="ls-import-samples-template" class="ls-pointer ls-box">
		...
		<ul class="inner">
        	<li>
				<a href="<?php echo wp_nonce_url('?page=layerslider&action=import_sample&slider=my-second-slider.zip', 'import-sample-sliders') ?>">
					<div class="preview"><img src="<?php echo LS_ROOT_URL.'/demos/creativo.jpg' ?>"></div>
					<div class="title">Creativo Demo Slider</div>
				</a>
			</li>
